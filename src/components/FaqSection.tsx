...
const FAQS: FAQ[] = [
    ...
    },
    {
        ...
        a: (
            <>
                静止画像に関しましては基本的には1回まで無料修正を承っております。<br />
                GIFアニメーション画像に関しては別途料金が必要になります。<br />
                納品後の大幅な変更は別途料金をお願いする場合がございます。<br />
    ...
    },
    {
        ...
        a: (
            <>
                「爆速お試しプラン」に関しては最短で当日納品を行っております。<br />
                「煽りコピー・構成プラン」に関しては、最短24時間以内で納品しております。
            </>
        ),
    },
    {
