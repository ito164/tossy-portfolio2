        ...
        <section id="contact" className="py-24 px-4 bg-black relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <div className="text-center mb-12">
                    ...
                    <a
                        href="https://x.com/gira_toshi"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-[var(--color-neon-gold)] hover:text-white transition-colors border border-[var(--color-neon-gold)] rounded-full px-6 py-2"
                    >
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                        <span className="font-bold text-sm">X (旧Twitter) のDMからも受付中！</span>
                    </a>
                </div>
